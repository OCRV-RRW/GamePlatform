...
import { API_DELETE_USER_PATH } from "../ApiPathes";

const fetch_delete_user_response = (access_token: string, query_search?: string) : Promise<Response> => 
    fetch(API_DELETE_USER_PATH + query_search, set_request_options({method: 'DELETE', access_token: access_token})
)
